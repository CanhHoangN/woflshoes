...
--
-- Host: localhost
-- Generation Time: Oct 15, 2019 at 06:31 PM
...
(5, 'Taylor All Star Limo', 3, '163339C-DRAKE-650x650.jpg', 'IMG_3087-copy-650x650.jpg', 'IMG_3088-copy-650x650.jpg', 300000, 'Mạnh mẽ - Bí ẩn - Cá tính là những từ dành cho thiết kế mới mẻ, độc đáo này. Toàn bộ thân giày được làm từ chất liệu da cao cấp có độ bền bỉ, giúp bạn dễ dàng vệ sinh. Điểm nhấn của sản phẩm là phần dây giày được thiết kế theo dạng tròn có màu vàng nổi bật trên nền đen.', 1, '2019-04-29 10:12:21', '2019-10-06 17:04:20'),
(6, 'Taylor All Star 1970s', 3, '163297C-DRAKE-650x650.jpg', 'IMG_1628-copy-650x650.jpg', 'IMG_1633-650x650.jpg', 1530000, 'Vẫn là màu vàng best-seller của nhà Converse, tuy nhiên lần này lại là tone vàng vintage kết hợp với thiết kế cổ điển của dòng Chuck 1970s. Với đế giày cao, trắng ngà và dây giày có phần thanh mảnh hơn, form giày cứng cáp cùng chất liệu vải êm nhẹ, chắc chắn đây là siêu phẩm bạn phải sở hữu.', 1, '2019-04-29 10:14:26', '2019-10-06 06:25:43'),
(7, 'Chuck Taylor All Star', 3, '131274-650x650.jpg', 'IMG_4659-650x650.jpg', 'IMG_4661-650x650.jpg', 1350000, 'Với thiết kế cổ điển được ưa chuộng của dòng Classic đi kèm với chất liệu da mềm nhẹ, có độ bóng, phần để cao su bền chắc cùng đường viền đen đặc trưng. Phiên bản màu đen bằng da của Converse Classic cổ thấp chắc chắn là item đơn giản phù hợp với mọi phong cách đáng để bạn sở hữu.', 1, '2019-04-29 10:15:55', '2019-10-06 07:03:35'),
(8, 'Palladium Pampalicious', 4, '96205-676-M-DRAKE-1-650x650.jpg', '96205-676-M-DRAKE6-650x650.jpg', '96205-676-M-DRAKE5-650x650.jpg', 1710000, 'Ngọt ngào với tone màu Hồng Blossom cực nữ tính với chất liệu vải Canvas bền chắc. Điểm đặc biệt chính là phần đế giày và một vài chi tiết trang trí được thiết kế trong suốt, đồng bộ với thân giày cho bạn sản phẩm độc đáo, bắt mắt. Diện item này với mọi outfit bạn sẽ trở nên cực kỳ thời trang và sành điệu.', 1, '2019-04-29 13:00:30', '2019-10-06 06:25:57'),
(9, 'Palladium Pallabrouse', 4, '75333-219-M-650x650.jpg', 'IMG_6570-copy-650x650.jpg', 'IMG_6555-copy-650x650.jpg', 1750000, 'Với tone màu nâu mạnh mẽ và phấn đế được làm từ chất liệu Gum cùng kiểu dáng cổ bẻ theo phong cách \"đường phố\"', 1, '2019-04-29 13:02:34', '2019-10-06 07:03:52'),
...
(11, 'GIÀY NIKE AIR MAX 270', 5, 'giay_nike_air_27_c_black_sdl651505877_7_3c272_4f51d2a047df4a7aac2fbaf2e807e628_1024x1024.jpg', 'nike-air-max-270-triple-black-on-feet-look-3.jpg', 'nike-air-max-270-triple-black-release-closer-look-05-1024x719.jpg', 2750000, 'Đây là một trong những dòng giày Nike mới được sản xuất dựa trên công nghệ đế Air nổi tiếng, với thiết kế hiện đại và cực kỳ êm ái !', 1, '2019-04-29 13:23:49', '2019-10-06 06:26:28'),
(12, 'SK8-HI', 1, 'download1.png', 'download2.png', 'download3.png', 1500000, 'Sk8-Hi, đỉnh cao có dây buộc huyền thoại, nổi bật với lớp vải bạt và da lộn chắc chắn, các ngón chân được thi hành lại để chống lại sự hao mòn lặp đi lặp lại, cổ áo độn để hỗ trợ và linh hoạt, và đế ngoài bằng cao su đặc trưng.', 1, '2019-10-06 06:29:16', '2019-10-06 06:29:16'),
(13, 'Cordura SK8-HI', 1, 'download4.png', 'download5.png', 'download6.png', 1624000, 'Mùa này, Vans đang hợp tác với CORDURA®, công ty đã được các nhà sản xuất thiết bị và trang phục hiệu suất cao lựa chọn trong hơn 45 năm. Được chế tạo bằng các công nghệ sợi có độ bền cao, CORDURA® Old Skool có trọng lượng cho trọng lượng.', 1, '2019-10-06 06:31:12', '2019-10-06 06:31:12');
...
--
ALTER TABLE `products`
  MODIFY `productCode` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
